import { ReleasesSearchResult } from "@repo/shared/types/releases"
...
async function searchByAniListId(id: number): Promise<ReleasesSearchResult[]> {
...
function getTorrentFile(res: ReleasesSearchResult): String {
